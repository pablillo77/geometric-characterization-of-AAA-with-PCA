[README.md](https://github.com/user-attachments/files/29818726/README.md)
...
7. **Shape-mode reconstruction** — synthetic shapes are reconstructed by moving ±k·σ along each principal direction from the mean shape, making each abstract component visually interpretable.
